    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTransferKey", x => x.KeyId);
                    table.ForeignKey(
                        name: "FK_UserTransferKey_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceiverKeyId = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_UserTransferKey_ReceiverKeyId",
                        column: x => x.ReceiverKeyId,
                        principalTable: "UserTransferKey",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTransferKey_UserId",
                table: "UserTransferKey",
                column: "UserId");
        }
